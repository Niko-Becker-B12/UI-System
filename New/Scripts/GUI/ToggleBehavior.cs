...
namespace Showroom.UI
{
    ...
    public class ToggleBehavior : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
            ...
            if (clickableOnce)
            {
                ...
                if (!wasClicked)
                {
                    ...
                    if (isActive)
                    {
                        ...
                        for (int i = 0; i < onSetDeactive.Count; i++)
                        {

                            Function.InvokeEvent(onSetDeactive[i], this);
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < onSetActive.Count; i++)
                        {

                            Function.InvokeEvent(onSetActive[i], this);
