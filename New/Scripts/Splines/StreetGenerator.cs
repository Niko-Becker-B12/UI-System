...
namespace Unity.Splines.Examples
{
    ...
    public class StreetGenerator : MonoBehaviour
    {
        ...
        public bool useSplineLengthForTextureScale = false;
        ...
        public void Loft(Spline spline, int widthDataIndex)
        {
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                if(useSplineLengthForTextureScale)
                {

                    m_Textures.Add(new Vector2(0f, t * spline.GetLength()));
                    m_Textures.Add(new Vector2(1f, t * spline.GetLength()));
