...
public class GameManager : SingletonPersistent<GameManager>
{
    ...
    public static event Action<int> onPlayerSwitchScenes;
    public static event Action<int, string> onPlayerNewCustomID;

    public int currentClientIndex = 0;

    public List<SkinDataObject> clientSkinDataSets = new List<SkinDataObject>();
