...
//
    ...
    protected override OdinMenuTree BuildMenuTree()
    {
        ...
        var s = tree.AddAllAssetsAtPath("Palettes", "Content/GUI/Styles/",
            typeof(UiSkinPalette), true, true);

        foreach(var t in tree.MenuItems[1].ChildMenuItems)
        {

            tree.AddAllAssetsAtPath($"Palettes/{t.Name}", $"Content/GUI/Styles/{(t.Value as UiSkinPalette).displayName}", typeof(ComponentSkinDataObject), true);
    ...
    private class PaletteMenuItem : OdinMenuItem
    {
        ...
        public PaletteMenuItem(OdinMenuTree tree, UiSkinPalette instance) : base(tree, instance.displayName, instance)
        {
