...
namespace GPUI
{
    public class ButtonBehavior : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        [Header("On Mouse Enter")] [Space] public List<Function> onMouseEnter = new List<Function>();

        [Header("On Mouse Down")] [Space] public List<Function> onMouseDown = new List<Function>();

        [Header("On Mouse Exit")] [Space] public List<Function> onMouseExit = new List<Function>();

        [Header("On Button Reset")] [Space] public List<Function> onButtonReset = new List<Function>();
        ...
        public static void DrawDottedLineWithShadow(Color shadowColor, Vector2 screenOffset, Vector3 p1, Vector3 p2,
